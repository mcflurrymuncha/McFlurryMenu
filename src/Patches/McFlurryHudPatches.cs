...
public static class HudManager_Update
{
    public static void Postfix(HudManager __instance)
    {
        __instance.ShadowQuad.gameObject.SetActive(!McFlurryESP.IsFullbrightActive()); // Fullbright
        ...
        McFlurryCheats.UseVentCheat(__instance);
        McFlurryESP.ZoomOut(__instance);
        McFlurryESP.FreecamCheat();
